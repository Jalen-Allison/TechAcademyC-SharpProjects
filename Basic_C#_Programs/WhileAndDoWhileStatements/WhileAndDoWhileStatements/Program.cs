...
namespace WhileAndDoWhileStatements
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int count = 1;
            Console.WriteLine("Printing numbers from 2 to 11");
            while (count <= 10)   //well keep running as long as its true
            {
                count = count + 1; //increment by 1 after checking the condition
